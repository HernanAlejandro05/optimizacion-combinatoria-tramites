...
excel_data = pd.read_excel(r'C:\Users\alejo\.spyder-py3\combinaciones_96_filtrados.xlsx')
...
for row in matriz:
    ...
    condicion_1 = (t5 >= 4 and t5 <= 12)
    condicion_2 = (t4 >= 4 and t4 <= 9)
    condicion_3 = (t3 >= 3 and t3 <= 9)
    condicion_4 = (t2 >= 2 and t2 <= 6)
